...
ActiveRecord::Schema.define(version: 2018_09_13_102910) do
  ...
  create_table "ressources", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "label", limit: 50
    t.text "uri", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["label"], name: "index_ressources_on_label"
    t.index ["uri"], name: "index_ressources_on_uri", unique: true
  end
